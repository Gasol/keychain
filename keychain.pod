...
S<[ --host I<name> ] [ --lockwait I<seconds> ] [ --apple-use-keychain ]>
...
=item B<--apple-use-keychain>

Each passphrase will also be stored in the user's keychain when adding
identities. Only supported on macOS.
